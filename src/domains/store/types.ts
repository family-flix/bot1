...
export type ModelParam<F extends (...args: any[]) => any> = NonNullable<
  Parameters<F>[number]
>;
export type ModelQuery<T extends ModelKeys> = NonNullable<
  Parameters<PrismaClient[T]["findMany"]>[0]
>["where"];
export type ModelUpdateInput<T extends ModelKeys> = NonNullable<
...
export type EpisodeProfileWhereInput = NonNullable<
  ModelQuery<"episode_profile">
>;
export type MemberNotifyWhereInput = NonNullable<
  ModelQuery<"member_notification">
>;
